<template>
  <div id="prolist">
    ...
    <div class="menuView" v-show="title=='卡项明细'">
      ...
      <div class="menuItem btn-audio" :class="{select:chos==3}" @click="chos=3">
        <label class>开卡</label>
      </div>
      <div class="menuItem btn-audio" :class="{select:chos==4}" @click="chos=4">
        <label class>充值</label>
      </div>
      <div class="menuItem btn-audio" :class="{select:chos==5}" @click="chos=5">
        <label class>还款</label>
      </div>
      <div class="menuItem btn-audio" :class="{select:chos==6}" @click="chos=6">
        <label class>退款</label>
      </div>
    </div>
    <div class="bomView" v-show="chos==1&&title=='营收明细'">
      <el-table :data="tableData" stripe style="width: 100%">
        <el-table-column
          ...
          :filters="option"
        ></el-table-column>
        <el-table-column prop="date" label="单号" width="150"></el-table-column>
        <el-table-column prop="name" label="结账时间"></el-table-column>
        <el-table-column prop="address" label="客户信息"></el-table-column>
        <el-table-column
          prop="address"
          label="消费内容"
          width="350"
          ...
          :filters="option"
        ></el-table-column>
        <el-table-column prop="address" label="服务人员" :filter-method="filterType" :filters="option"></el-table-column>
        <el-table-column prop="address" label="支付方式" :filter-method="filterType" :filters="option"></el-table-column>
    ...
    <div class="bomView" v-show="chos==2&&title=='营收明细'">
      <el-table :data="tableData" stripe style="width: 100%">
...
export default {
  ...
  data () {
    return {
      ...
      title: '营收明细',
      chos: 1,
      option: [{ text: '收银', value: '收银' }, { text: '售卡', value: '售卡' }, { text: '充值', value: '充值' }],
